(function(c,t,e){"use strict";const u=t.webpackModules.findByDisplayName("FormDivider"),v=e.React.memo(({icon:r,header:o,description:a,separator:n,collapsible:i})=>(t.webpackModules.findByProps("headerSubtext"),t.webpackModules.findByProps("marginBottom40"),t.webpackModules.findByProps("wrappedLayout"),t.webpackModules.findByProps("h1","h2","h3"),t.webpackModules.findByProps("size24"),t.webpackModules.findByProps("base"),e.React.createElement("div",{className:"vz-dashboard-section-header-wrapper"},e.React.createElement("div",{className:"vz-dashboard-content-header-inner-wrapper"},e.React.createElement("h2",{className:"vz-dashboard-section-header size24, base, content"},o)),a&&e.React.createElement("h4",{className:"vz-dashboard-section-header-description h1 headerSubtext"},a),n&&e.React.createElement(u,null))));var l=e.React.memo(({header:r,description:o,icon:a,separator:n=!0,collapsible:i=!1,id:s,className:p,children:z})=>e.React.createElement("div",{className:"vz-dashboard-section"+p},r&&e.React.createElement(v,{header:r,description:o,icon:a,separator:n,collapsible:i}),e.React.createElement("div",{className:"vz-dashboard-section-contents"},z)));const b=t.webpackModules.findByDisplayName("DropdownButton");var d=e.React.memo(({icon:r,header:o,disabled:a,description:n,buttonText:i,buttonOnClick:s,route:p})=>e.React.createElement("div",{className:"vz-dashboard-home-features-card-wrapper"},e.React.createElement("div",{className:"vz-dashboard-home-features-card"},e.React.createElement("div",{className:"vz-dashboard-home-features-card-header"},o),e.React.createElement("div",{className:"vz-dashboard-home-features-card-body"},n),e.React.createElement("div",{className:"vz-dashboard-home-features-card-footer"},e.React.createElement(b,{className:"vz-dashboard-home-features-button",children:i}))))),m=e.React.memo(({color:r,className:o,...a})=>e.React.createElement("div",{class:"vz-wave-divider",style:{color:r}},e.React.createElement("svg",{class:"vz-wave-divider-svg",xmlns:"http://www.w3.org/2000/svg",viewBox:"0 0 1440 100",...a},e.React.createElement("path",{class:"vz-wave-divider-svg-path",fill:"currentColor",d:"M826.337463,25.5396311 C670.970254,58.655965 603.696181,68.7870267 447.802481,35.1443383 C293.342778,1.81111414 137.33377,1.81111414 0,1.81111414 L0,150 L1920,150 L1920,1.81111414 C1739.53523,-16.6853983 1679.86404,73.1607868 1389.7826,37.4859505 C1099.70117,1.81111414 981.704672,-7.57670281 826.337463,25.5396311 Z"})))),g=e.React.memo(()=>{const{getCurrentUser:r}=t.webpackModules.findByProps("getCurrentUser"),{username:o}=r();return e.React.createElement(e.React.Fragment,null,e.React.createElement(l,{className:"vz-dashboard-home-section-cta"},e.React.createElement("div",{className:"vz-dashboard-home-cta"},e.React.createElement("div",{className:"vz-dashboard-home-cta-overlay-background"},e.React.createElement("div",{className:"vz-dashboard-home-cta-background"})),e.React.createElement("div",{className:"vz-dashboard-home-cta-content"},e.React.createElement("div",{className:"vz-dashboard-home-cta-content-header-wrapper"},e.React.createElement("h1",{className:"vz-dashboard-home-cta-content-header"},"Welcome, ",o,"!"),e.React.createElement("h3",{className:"vz-dashboard-home-cta-content-description"},"You've made the right choice. The power of customization is now at your fingertips. Check out the features below to learn how to harness your newfound power."))),e.React.createElement(m,null))),e.React.createElement(l,{className:"vz-dashboard-home-section-features"},e.React.createElement("div",{className:"vz-dashboard-home-features-wrapper"},e.React.createElement("div",{className:"vz-dashboard-home-features"},e.React.createElement(d,{icon:"Plugin",header:"Discover Plugins",description:"Explore our vast collection of official plugins. Plugins can add just about any new feature you can imagine to Discord.",buttonText:"Browse Plugins",route:"/vizality/plugins/browse"}),e.React.createElement(d,{icon:"Theme",header:"Discover Themes",description:"Explore our vast collection of official themes. Themes can change just small portions of the app or they can be full-blown redesigns.",buttonText:"Browse Themes",route:"/vizality/themes/browse"}),e.React.createElement(d,{icon:"UnknownUser",header:"Become a Developer",description:"Find out what it takes to start making your own plugins and themes. Come check out the guidelines and all the info you need to become an addon developer for Vizality.",buttonText:"Learn How",route:"/vizality/development"}),e.React.createElement(d,{icon:"Science",header:"Read the Docs",description:"Read about all the building blocks and tools we provide to make building plugins and themes easier for you.",buttonText:"Start Reading",route:"/vizality/docs"})))))});const f=`
:root {
...
`;let h,w;var x=()=>({onLoad(){const r=t.webpackModules.findByDisplayName("SettingsView");h=c.after("getPredicateSections",r.prototype,(o,a)=>{const n=a.findIndex(s=>s.section=="changelog")-1;if(n<0)return a;const i=[{section:"DIVIDER"},{section:"HEADER",label:"Vizality"},{section:"DASHBOARD",label:"Dashboard",element:g}];return a.splice(n,0,...i),a}),c.injectCSS(f)},onUnload(){h(),w()}});return x})(cumcord.patcher,cumcord.modules,cumcord.modules.common);
